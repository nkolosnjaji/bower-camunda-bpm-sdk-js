...
},{"./../base-class":31,"./../events":32,"q":54}],2:[function(_dereq_,module,exports){
...
},{"./../events":32,"./../utils":44,"buffer":45,"q":54,"superagent":55}],4:[function(_dereq_,module,exports){
'use strict';
var Events = _dereq_('./../events');
...
/** @lends  CamSDK.client.resource.ProcessDefinition */
   ...
   */
    statistics: function(data, done) {
      ...
      var path = this.path + extra +'/statistics';
      return this.http.get(path, {
        data: data,
        done: done || noop
      });
...
},{"./../abstract-client-resource":1,"q":54}],25:[function(_dereq_,module,exports){
'use strict';
...
},{"../../utils":44,"./../abstract-client-resource":1,"q":54}],30:[function(_dereq_,module,exports){
'use strict';
...
},{"./../base-class":31,"./../events":32,"./constants":34,"./controls/choices-field-handler":36,"./controls/file-download-handler":37,"./controls/input-field-handler":38,"./dom-lib":39,"./variable-manager":42,"moment":53}],34:[function(_dereq_,module,exports){
'use strict';
...
},{"fast-xml-parser":50}],42:[function(_dereq_,module,exports){
'use strict';
...
},{"FWaASH":49}],55:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
